...
if($file_name!=""){
  if($sw==0){if((!isset($_SESSION['rand']))||($_SESSION['rand']!=$_POST['captcha'])){echo "Your session was closed due to a captcha error or timeout! Please go to the web and re-upload! [Do not reload or F5]";session_unset();session_destroy();die();};};
